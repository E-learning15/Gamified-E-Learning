 ...
 * @author user
 */
public class allQuestion2 extends javax.swing.JFrame {

    /**
     * Creates new form allQuestion2
     */
    public allQuestion2() {
        initComponents();
        try
        ...
        ResultSet rs = st.executeQuery("SELECT * FROM trorfa");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 800, 440));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allQuestion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
